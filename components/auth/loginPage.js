      ...
      <div className="bg-white w-full max-w-sm rounded-2xl border border-stone-200 shadow-sm p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative  rounded-xl w-16 h-16 flex items-center justify-center mb-3">
            <Image className='object-contain' fill src={"https://res.cloudinary.com/dt4qdszmp/image/upload/v1773570286/get-me-a-chai-logo_cpdcuh.png"} alt='web-logo'/>
          </div>
          <h1 className={`text-xl flex gap-2 font-bold ${whichPage !== "login" ? "font-dancing font-extrabold text-amber-400 pl-1.5" : "text-stone-800"} `}>
            <p className='text-stone-800'>{whichPage !== "login" && "Join"}</p>
            {whichPage === "login" ? "Welcome back" : "GetMeAChai"}
          </h1>
          <p className="text-sm text-stone-400 mt-1">
            {whichPage === "login" ? "Sign in to continue" : "Create your account"}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <Image width={18} height={18} src="/images/web-picture/github.png" alt="github" />
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 w-full py-2.5 px-4 rounded-xl border border-stone-200 bg-white hover:bg-stone-50 text-stone-700 text-sm font-medium transition-colors shadow-sm"
          >
            <Image width={18} height={18} src="/images/web-picture/google.png" alt="google" />
        ...
        <p className="text-xs text-stone-400 text-center mt-3">
          {whichPage === "login" ? "Don't have an account? " : "Already have an account? "}
          <Link href={whichPage === "login" ? "/signup" : "/login"} className="text-amber-500 font-medium hover:underline">
